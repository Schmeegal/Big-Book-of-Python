...
NUM_DIGITS = 3 # try setting to one or 10
MAX_GUESSES = 10 # try setting to 1 or 100
    ...
    while True: # Main game loop.
        ...
        while numGuesses <= MAX_GUESSES:
            ...
            while len(guess) != NUM_DIGITS or not guess.isdecimal():
                ...
                if guess == secretNum:
                    break # They're correct, so break out of this
...
def getSecretNum():
    ...
    numbers = list('0123456789') #create a lsit of digits 0 to 9
...
def getClues(guess, secretNum):
    ...
    if len(clues) == 0:
        ...
        #Sort the clues intp alphabetical order so their original order doesn't give info away.
        clues.sort()
